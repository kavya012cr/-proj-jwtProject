...
public class ConfirmationToken {
	...
	@SequenceGenerator (name = "confirmation_tokens_sequence", 
			sequenceName = "confirmation_tokens_sequence", allocationSize = 1)
	@Id
...
//	@Column(nullable = false)
	...
	public void setCreatedAt(LocalDateTime createdAt) {
	  ...
	  public void setConfirmedAt(LocalDateTime confirmedAt) { this.confirmedAt =
	  confirmedAt; }
